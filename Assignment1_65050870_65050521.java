...
public class Assignment1_65050870_65050521 extends JPanel {
    public static void main(String[] args) {
        Assignment1_65050870_65050521 m = new Assignment1_65050870_65050521();

        JFrame f = new JFrame();
        f.add(m);
        f.setTitle("Assignment1_65050870_65050521");
        f.setSize(600, 600);
    ...
    private void lizadonDragon(Graphics g, BufferedImage buffer, int x, int y) {
        ...
        Color redFire = Color.decode("#681E17");
        Color yellowFire = Color.decode("#736532");
    ...
    private void cup(Graphics g2d, BufferedImage buffer, int x, int y) {
        ...
        plot(g2d, 222, 365);
        plot(g2d, 221, 366);
        buffer = floodFill2(buffer, 206, 365, smokeColor, smokeColor);
        buffer = floodFill2(buffer, 214, 360, smokeColor, smokeColor);
        buffer = floodFill2(buffer, 214, 355, smokeColor, smokeColor);
        plot(g2d, 203, 378);
        plot(g2d, 203, 375);
        plot(g2d, 221, 365);
        plot(g2d, 221, 363);
