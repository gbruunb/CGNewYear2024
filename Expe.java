...
public class Expe extends JPanel {
        ...
        private void test(Graphics2D g2d, int i, int j) {
        }
        ...
        private void gift(Graphics g, BufferedImage buffer, int x, int y) {
                ...
                for (int i = 0; i < xPoints.length - 3; i += 3) {
                        bezier_Curve(g, new int[] { xPoints[i] + x, xPoints[i + 1] + x, xPoints[i + 2] + x,
                                        xPoints[i + 3] + x },
                                        new int[] { yPoints[i] + y, yPoints[i + 1] + y, yPoints[i + 2] + y,
                                                        yPoints[i + 3] + y });
                }
                ...
                // xPoints = new int[]{19, 21, 24, 25, 25, 25, 24, 23, 21, 20, 20, 17, 15, 15,
                // 15, 15, 15, 15, 17};
                // yPoints = new int[]{307, 306, 306, 309, 309, 310, 311, 312, 312, 312, 312,
                // 312, 312, 312, 312, 310, 310, 310, 308};
                xPoints = new int[] { 19, 21, 24, 25, 25, 25, 24, 23, 21, 20, 20, 17, 15, 15, 15, 15, 15, 15, 17 };
                yPoints = new int[] { 307, 306, 306, 309, 309, 310, 311, 312, 312, 312, 312, 312, 312, 312, 312, 310,
                                310, 310,
                                308 };
        ...
        private void christmasTree(Graphics g, BufferedImage buffer, int x, int y) {
                g.setColor(Color.white);
                double[] xPoints = { 12, 12.3455, 13.2721, 16.3005, 18.5576, 24.6485, 25.1167, 28.6134, 28.931, 31.686,
                                32.0698,
                                35.9322, 36.9498, 41.3041, 41.5605, 46.1792, 47.1407, 51.8008, 52.6668, 55.1776,
                                55.0872, 57.4208,
                                58.2147, 62.0222, 62.7171, 67.0826, 67.879, 71.8208, 71.9313, 76.3136, 77.3967, 82.0345,
                                82.3698,
                                86.0246, 86.6151, 89.4301, 89.2468, 93.1014, 94.9177, 99.9534, 101.6439, 102.3559,
                                101.3569 };
                double[] yPoints = { 280, 282.6668, 283.6118, 285.2269, 282.549, 283.347, 286.0635, 285.9456, 284.3062,
                                283.517,
                                287.7048, 288.2955, 284.8327, 285.188, 289.6872, 290.2794, 286.8385, 287.1017, 288.537,
                                287.5257,
                                286.1701, 285.7353, 288.9123, 289.0994, 285.1078, 284.9017, 288.1586, 287.8639,
                                285.4115, 284.5398,
                                287.3642, 286.7154, 284.8509, 285.1852, 288.162, 287.8327, 284.6062, 283.2734, 287.3722,
                                286.7641,
                ...
                xPoints = new double[] { 19, 19.5619, 20.4934, 24.2898, 26.1413, 29.8096, 29.4828, 32.4012, 33.4852,
                                36.5222,
                                36.6383, 39.4784, 40.3789, 43.7359, 44.2635, 47.6193, 48.503, 51.3989, 51.6067, 54.5028,
                                55.4789,
                                58.4221, 58.6975, 61.515, 62.3467, 65.6281, 66.2416, 69.5977, 70.2852, 73.699, 74.3085,
                                77.7199,
                                78.5001, 81.4501, 81.901, 84.1645, 84.1123, 87.8535, 89.3613, 93.345, 94.7638, 95.2366,
                                94.1809 };
                yPoints = new double[] { 251, 252.7323, 254.743, 255.3906, 251.4286, 252.5564, 256.7509, 257.2301,
                                253.7849,
                                254.2162, 257.8672, 258.1442, 253.942, 254.0621, 258.9379, 259.0579, 254.8643, 255.1268,
                                258.8775,
                                259.1321, 254.876, 255.1159, 258.9283, 259.0834, 253.9913, 254.0086, 258.9541, 259.0417,
                                254.9901,
                                255.0098, 258.9946, 259.0055, 254.8903, 255.1061, 259.0386, 258.9591, 254.5276, 253.482,
                                257.347,
                ...
                xPoints = new double[] { 27, 27.5597, 28.3201, 30.7225, 32.1643, 35.5726, 35.5188, 38.606, 39.7043,
                                42.207,
                                42.0671, 44.0834, 45.0087, 47.014, 46.8064, 49.2085, 50.3385, 53.5117, 54.0421, 56.0625,
                                56.0662,
                                57.9854, 58.7167, 61.262, 61.7613, 64.2421, 64.7786, 67.2103, 67.6634, 70.1782, 70.6937,
                                73.3063,
                                73.8218, 76.3387, 76.8137, 79.1636, 79.4628, 82.412, 83.071, 86.285, 87.9468, 88.038,
                                87.2498 };
                yPoints = new double[] { 226, 228.1188, 228.8246, 229.4444, 226.545, 227.3898, 229.7668, 230.2529,
                                227.6218,
                                228.3523, 230.8727, 231.1479, 227.8498, 228.1536, 231.7197, 232.2838, 228.8437,
                                229.1422, 232.1279,
                                231.8581, 228.0964, 227.8983, 232.0116, 231.9886, 228, 228, 232.0103, 231.9897,
                                228.0434, 227.9617, 231,
                                231, 227.9617, 228.0435, 232.0029, 231.9971, 228.186, 227.8291, 230.9344, 231.0437,
                                229.7322, 226.7646,
                                225.5717 };
        ...
        private void cat(Graphics g, BufferedImage buffer, int y) {
                ...
                // buffer = floodFill(buffer, 360, 527, Color.decode("#80C014"),
                // Color.decode("#5A3F2B"));
                ...
                // bezier_Curve(g, new int[] { 337, 336, 335, 335}, new int[] { 553, 556, 556,
                // 558});
                // bezier_Curve(g, new int[] { 337, 336, 335, 335}, new int[] { 553, 556, 556,
                // 558});
                // bezier_Curve(g, new int[] { 337, 336, 335, 335}, new int[] { 553, 556, 556,
