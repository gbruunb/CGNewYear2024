...
public class Expe extends JPanel {
    ...
    private void ajmo(Graphics g, BufferedImage buffer, int x, int y) {
        ...
        for (int i = 0; i < xPoints.length - 3; i += 3) {
            bezier_Curve(g, new int[] { xPoints[i] + x, xPoints[i + 1] + x, xPoints[i + 2] + x, xPoints[i + 3] + x },
                    new int[] { yPoints[i] + y, yPoints[i + 1] + y, yPoints[i + 2] + y, yPoints[i + 3] + y });
        }
        ...
        xPoints = new int[] { 451, 451, 448, 447, 443, 439, 437, 434, 433, 432, 431, 432, 433, 433, 434, 435, 435, 436,
                438, 443, 444, 446, 447, 451, 451 };
        yPoints = new int[] { 465, 464, 462, 462, 460, 461, 461, 461, 462, 463, 464, 466, 467, 467, 467, 467, 467, 467,
                467, 467, 467, 467, 467, 466, 465 };
        ...
        xPoints = new int[] { 448, 447, 446, 446, 445, 445, 447, 447, 448, 449, 449, 449, 450, 450, 450, 451, 451, 452,
                453, 454, 454, 455, 455, 455, 456, 456, 456, 457, 457, 458, 459, 459, 459, 460, 460, 461, 463, 464, 465,
                466, 466, 466, 467, 467, 468, 469, 469, 469, 469, 468, 468, 467, 448 };
        yPoints = new int[] { 495, 495, 496, 498, 500, 503, 504, 504, 504, 504, 503, 502, 502, 501, 501, 501, 500, 500,
                500, 499, 500, 501, 501, 501, 503, 504, 504, 505, 505, 505, 505, 504, 503, 503, 502, 501, 501, 501, 502,
                503, 504, 504, 505, 505, 504, 504, 502, 500, 500, 499, 498, 497, 495 };
        ...
        xPoints = new int[] { 442, 442, 443, 444, 445, 446, 449, 452, 453, 454, 455, 455, 457, 458, 459, 461, 461, 462,
                468, 468, 469, 469, 470, 470, 471, 471, 469, 468, 467, 467, 467, 466, 465, 461, 457, 455, 454, 449, 447,
                444, 442 };
        yPoints = new int[] { 518, 518, 518, 518, 517, 516, 515, 512, 511, 512, 512, 513, 514, 514, 512, 512, 512, 511,
                518, 518, 519, 519, 518, 518, 519, 519, 518, 520, 520, 521, 522, 522, 523, 524, 524, 524, 524, 523, 520,
                518, 518 };
        ...
        x += 1;
        y += 2;
        xPoints = new int[] { 445, 445, 446, 447, 449, 451, 452, 453, 452, 453, 454, 456, 458, 459, 459, 460, 461, 463,
                467, 445 };
        yPoints = new int[] { 517, 517, 516, 516, 515, 514, 515, 516, 516, 517, 518, 518, 517, 516, 515, 515, 514, 515,
                518, 517 };
    ...
    private void cat(Graphics g, BufferedImage buffer, int x, int y) {
        ...
        // buffer = floodFill(buffer, 360, 527, Color.decode("#3F5E09"),
        // Color.decode("#5A3F2B"));
    ...
    private void gift(Graphics g, BufferedImage buffer, int x, int y, Color boxColor) {
        g.setColor(Color.black);
        int[] xPoints = { 22, 20, 20, 18, 15, 13, 12, 12, 15, 18, 18, 21, 21, 23, 24, 25, 26, 27, 27, 27, 28, 29, 31,
                34, 36, 37, 38, 38, 37, 35, 34, 29, 28, 26, 27, 25, 23, 22, 22 };
        int[] yPoints = { 326, 327, 327, 327, 328, 326, 325, 322, 321, 321, 321, 323, 325, 325, 325, 325, 325, 325, 326,
                326, 325, 323, 322, 321, 322, 323, 324, 326, 327, 327, 328, 328, 326, 327, 328, 329, 328, 328, 326 };
        for (int i = 0; i < xPoints.length - 3; i += 3) {
            bezier_Curve(g, new int[] { xPoints[i] + x, xPoints[i + 1] + x, xPoints[i + 2] + x, xPoints[i + 3] + x },
                    new int[] { yPoints[i] + y, yPoints[i + 1] + y, yPoints[i + 2] + y, yPoints[i + 3] + y });
        }

        xPoints = new int[] { 8 + 11, 8 + 11, 7 + 11, 6 + 11, 5 + 11, 3 + 11, 3 + 11, 3 + 11, 4 + 11, 5 + 11, 6 + 11,
                8 + 11, 8 + 11 };
        yPoints = new int[] { 310 + 15, 309 + 15, 308 + 15, 308 + 15, 307 + 15, 307 + 15, 308 + 15, 309 + 15, 310 + 15,
                310 + 15, 311 + 15, 311 + 15, 310 + 15 };
        ...
        xPoints = new int[] { 16 + 12, 16 + 12, 18 + 12, 20 + 12, 21 + 12, 23 + 12, 23 + 12, 23 + 12, 22 + 12, 20 + 12,
                18 + 12, 16 + 12, 16 + 12 };
        yPoints = new int[] { 311 + 15, 310 + 15, 309 + 15, 309 + 15, 309 + 15, 309 + 15, 309 + 15, 309 + 15, 311 + 15,
                311 + 15, 312 + 15, 311 + 15, 311 + 15 };
    ...
    private void ballOnChristmas(Graphics g, BufferedImage buffer, int x, int y, Color color) {
        ...
        int startY = -30;
        g.setColor(Color.decode("#000000"));
        int[] xPoints = { 44 + startX + x, 46 + startX + x, 49 + startX + x, 51 + startX + x, 52 + startX + x,
                52 + startX + x, 51 + startX + x, 50 + startX + x, 48 + startX + x, 46 + startX + x, 44 + startX + x,
                43 + startX + x, 42 + startX + x, 43 + startX + x, 44 + startX + x };
        int[] yPoints = { 268 + startY + y, 267 + startY + y, 267 + startY + y, 269 + startY + y, 271 + startY + y,
                273 + startY + y, 275 + startY + y, 276 + startY + y, 277 + startY + y, 277 + startY + y,
                276 + startY + y, 274 + startY + y, 272 + startY + y, 270 + startY + y, 268 + startY + y };
        g.drawPolygon(xPoints, yPoints, xPoints.length);
    ...
    private void lineOfLamp1(Graphics g, BufferedImage buffer, int x, int y) {
        int firstX = 23;
        int firstY = 262;
        int[] diffX = { 23 - firstX, 25 - firstX, 28 - firstX, 31 - firstX, 34 - firstX, 37 - firstX, 41 - firstX,
                44 - firstX, 48 - firstX, 51 - firstX, 55 - firstX, 59 - firstX, 63 - firstX, 67 - firstX, 71 - firstX,
                75 - firstX, 79 - firstX, 83 - firstX, 87 - firstX, 91 - firstX };
        int[] diffY = { 262 - firstY, 266 - firstY, 269 - firstY, 272 - firstY, 275 - firstY, 278 - firstY,
                280 - firstY, 283 - firstY, 285 - firstY, 288 - firstY, 290 - firstY, 292 - firstY, 294 - firstY,
                295 - firstY, 297 - firstY, 298 - firstY, 299 - firstY, 300 - firstY, 300 - firstY, 301 - firstY };
    ...
    private void lineOfLamp2(Graphics g, BufferedImage buffer, int x, int y) {
        int firstX = 34;
        int firstY = 211;
        int[] diffX = { 34 - firstX, 36 - firstX, 39 - firstX, 42 - firstX, 45 - firstX, 48 - firstX, 51 - firstX,
                55 - firstX, 58 - firstX, 62 - firstX, 65 - firstX, 69 - firstX, 73 - firstX, 77 - firstX, 81 - firstX,
                85 - firstX, 89 - firstX, 93 - firstX };
        int[] diffY = { 211 - firstY, 215 - firstY, 218 - firstY, 221 - firstY, 224 - firstY, 227 - firstY,
                230 - firstY, 232 - firstY, 235 - firstY, 237 - firstY, 240 - firstY, 242 - firstY, 244 - firstY,
                246 - firstY, 247 - firstY, 248 - firstY, 249 - firstY, 249 - firstY };
    ...
    private void lineOfLamp3(Graphics g, BufferedImage buffer, int x, int y) {
        ...
        int[] diffY = { 190 - firstY, 193 - firstY, 195 - firstY, 197 - firstY, 199 - firstY, 201 - firstY,
                203 - firstY };
    ...
    private void christmasTree(Graphics g, BufferedImage buffer, int x, int y) {
        ...
        double[] xPoints = { 12, 12.3455, 13.2721, 16.3005, 18.5576, 24.6485, 25.1167, 28.6134, 28.931, 31.686, 32.0698,
                35.9322, 36.9498, 41.3041, 41.5605, 46.1792, 47.1407, 51.8008, 52.6668, 55.1776, 55.0872, 57.4208,
                58.2147, 62.0222, 62.7171, 67.0826, 67.879, 71.8208, 71.9313, 76.3136, 77.3967, 82.0345, 82.3698,
                86.0246, 86.6151, 89.4301, 89.2468, 93.1014, 94.9177, 99.9534, 101.6439, 102.3559, 101.3569 };
        double[] yPoints = { 280, 282.6668, 283.6118, 285.2269, 282.549, 283.347, 286.0635, 285.9456, 284.3062, 283.517,
                287.7048, 288.2955, 284.8327, 285.188, 289.6872, 290.2794, 286.8385, 287.1017, 288.537, 287.5257,
                286.1701, 285.7353, 288.9123, 289.0994, 285.1078, 284.9017, 288.1586, 287.8639, 285.4115, 284.5398,
                287.3642, 286.7154, 284.8509, 285.1852, 288.162, 287.8327, 284.6062, 283.2734, 287.3722, 286.7641,
                284.8257, 281.1758, 279.5796 };
        ...
        xPoints = new double[] { 19, 19.5619, 20.4934, 24.2898, 26.1413, 29.8096, 29.4828, 32.4012, 33.4852, 36.5222,
                36.6383, 39.4784, 40.3789, 43.7359, 44.2635, 47.6193, 48.503, 51.3989, 51.6067, 54.5028, 55.4789,
                58.4221, 58.6975, 61.515, 62.3467, 65.6281, 66.2416, 69.5977, 70.2852, 73.699, 74.3085, 77.7199,
                78.5001, 81.4501, 81.901, 84.1645, 84.1123, 87.8535, 89.3613, 93.345, 94.7638, 95.2366, 94.1809 };
        yPoints = new double[] { 251, 252.7323, 254.743, 255.3906, 251.4286, 252.5564, 256.7509, 257.2301, 253.7849,
                254.2162, 257.8672, 258.1442, 253.942, 254.0621, 258.9379, 259.0579, 254.8643, 255.1268, 258.8775,
                259.1321, 254.876, 255.1159, 258.9283, 259.0834, 253.9913, 254.0086, 258.9541, 259.0417, 254.9901,
                255.0098, 258.9946, 259.0055, 254.8903, 255.1061, 259.0386, 258.9591, 254.5276, 253.482, 257.347,
                256.8232, 255.5809, 252.4165, 251.2018 };
        ...
        xPoints = new double[] { 27, 27.5597, 28.3201, 30.7225, 32.1643, 35.5726, 35.5188, 38.606, 39.7043, 42.207,
                42.0671, 44.0834, 45.0087, 47.014, 46.8064, 49.2085, 50.3385, 53.5117, 54.0421, 56.0625, 56.0662,
                57.9854, 58.7167, 61.262, 61.7613, 64.2421, 64.7786, 67.2103, 67.6634, 70.1782, 70.6937, 73.3063,
                73.8218, 76.3387, 76.8137, 79.1636, 79.4628, 82.412, 83.071, 86.285, 87.9468, 88.038, 87.2498 };
        yPoints = new double[] { 226, 228.1188, 228.8246, 229.4444, 226.545, 227.3898, 229.7668, 230.2529, 227.6218,
                228.3523, 230.8727, 231.1479, 227.8498, 228.1536, 231.7197, 232.2838, 228.8437, 229.1422, 232.1279,
                231.8581, 228.0964, 227.8983, 232.0116, 231.9886, 228, 228, 232.0103, 231.9897, 228.0434, 227.9617, 231,
                231, 227.9617, 228.0435, 232.0029, 231.9971, 228.186, 227.8291, 230.9344, 231.0437, 229.7322, 226.7646,
                225.5717 };
        ...
        int[] yPointsInt = new int[] { 181 + y, 185 + y, 177 + y, 172 + y, 170 + y, 163 + y, 170 + y, 172 + y, 177 + y,
                185 + y };
...
bezier_Curve(g2d, new int[]{365+x, 366+x, 368+x, 367+x}, new int[]{286+y, 286+y, 276+y, 276+y});
    ...
    private static void grass(Graphics g, BufferedImage buffer) {
        ...
        // g.setColor(Color.decode("#6BB044"));
        g.setColor(Color.decode("#66AC44"));
        bezier_Curve(g, new int[] { 598, 595, 590, 582 }, new int[] { 409, 408, 410, 414 });
        bezier_Curve(g, new int[] { 582, 573, 569, 569 }, new int[] { 414, 418, 420, 423 });
        bezier_Curve(g, new int[] { 569, 568, 576, 587 }, new int[] { 423, 427, 431, 437 });
        bezier_Curve(g, new int[] { 587, 594, 598, 600 }, new int[] { 437, 441, 443, 442 });
        bezier_Curve(g, new int[] { 600, 607, 607, 598 }, new int[] { 442, 438, 413, 409 });
        // g.drawRect(580, 420, 1, 1);
        // buffer = floodFill2(buffer, 580, 420, Color.decode("6BB044"),
        // Color.decode("#6BB044"));
        buffer = floodFill(buffer, 580, 420, Color.decode("#3F5E09"), Color.decode("#66AC44"));
